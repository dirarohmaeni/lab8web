...
1. Buat folder baru dengan nama lab8_php_database pada docroot webserver (htdocs)
                ...
                <?php if($result): ?>
                    <?php while($row = mysqli_fetch_array($result)): ?>
                        <tr>
                            ...
                            <a href="hapus.php?id=<?= $row['id_barang']; ?>" onclick="return confirm('Hapus data ini?')">Hapus</a></td>
                        </tr>
                        <?php endwhile; else: ?>
                            <tr>
